...
content_id: 7cc7780e0aa47f55a619e6006203392e2829d47752b44cee8a8fb880a0262fc4
---

# Note

You should have a GeminiLLM class than handles LLM requests properly. This is an example (you can use it directly but make sure to adjust it so it works well with the concept implementation):
