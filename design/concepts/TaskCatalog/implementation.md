...
# My updated version based on feedback from test cases
```typescript
...
error: `Time block ${timeBlockId} already assigned to task ${taskId}`,
...
`Time block ${timeBlockId} not found in task ${taskId}'s schedules`,
...
error: `Failed to update task ${String(attribute)}: ${e.message}`,
...
error: `An unknown error occurred during task attribute update.`,
...
{ owner, taskId, newPreDependence }: {

owner: User;

taskId: Task;

newPreDependence: Task;
...
error: `Pre-dependence task with ID ${newPreDependence} does not exist`,
...
error: `An unknown error occurred while adding pre-dependence.`,
...
{ owner, taskId, oldPreDependence }: {

owner: User;

taskId: Task;

oldPreDependence: Task;
...
`Pre-dependence task ${oldPreDependence} not found in task ${taskId}'s preDependence`,
...
error: `An unknown error occurred while removing pre-dependence.`,
...
`Task ${taskId} cannot be deleted because it has dependent tasks (${

task.postDependence.join(", ")
